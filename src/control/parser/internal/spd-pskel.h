...
#ifndef CXX___XML_XSD_SPD_PSKEL_H
#define CXX___XML_XSD_SPD_PSKEL_H
...
namespace spd
{
  class softPkg_pskel: public ::xml_schema::complex_content
  {
    ...
    void
    type_parser (::spd::scaComplianceType_pskel&);
    ...
    ::spd::scaComplianceType_pskel* type_parser_;
  ...
  class scaComplianceType_pskel: public virtual ::xml_schema::nmtoken_pskel
  {
    public:
    // Parser callbacks. Override them in your implementation.
    //
...
#endif // CXX___XML_XSD_SPD_PSKEL_H
